...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java" import="com.qst.dms.po.Student" %>
...
<div class="x-nav">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right" href="/findStudent"
       title="刷新">
